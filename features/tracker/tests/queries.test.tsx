...
describe("tracker Query mutations", () => {
  it("calls each exact RPC mutation and invalidates only its tracker context", async () => {
    ...
    expect(invalidate).toHaveBeenCalledWith({ queryKey: trackerKeys.context("thr_1") });
