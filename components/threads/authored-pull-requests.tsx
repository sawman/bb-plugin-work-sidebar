...
import { pullRequestPresentation, pullRequestSignalPresentation, type PullRequestSignal } from "../../features/pull-requests/presentation";
import { orderStackLayers, type SidebarStack } from "../../work-model";

export type AuthoredPullRequest = { number: number; title: string; url: string; repository: string; state: "open" | "draft"; draft: boolean; head: string; base: string; checks: PullRequestSignal["checks"]; review: PullRequestSignal["review"]; reviewCommentCount: number; stack: SidebarStack | null; };
