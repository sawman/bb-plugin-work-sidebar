...
const paths: Record<string, React.ReactNode> = {
  ...
  GitMerge: <><circle cx="6" cy="6" r="2" /><circle cx="6" cy="18" r="2" /><circle cx="18" cy="12" r="2" /><path d="M6 8v8m2-2h6a4 4 0 0 0 4-4V8" /></>,
  ...
  Pencil: <><path d="m4 20 4.3-1 10.5-10.5a2.1 2.1 0 0 0-3-3L5.3 16z" /><path d="m14.5 6.7 3 3" /></>,
  User: <><circle cx="12" cy="8" r="3" /><path d="M5 20a7 7 0 0 1 14 0" /></>,
  UserClock: <><circle cx="9" cy="8" r="3" /><path d="M3 20a6 6 0 0 1 10.5-4" /><circle cx="18" cy="17" r="3" /><path d="M18 15.5V17l1 1" /></>,
